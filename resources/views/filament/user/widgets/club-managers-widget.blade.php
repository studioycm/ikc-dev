<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <x-slot name="description">
            Contact information for club management and breed promoters
        </x-slot>
        ...
        <div class="space-y-8">
            ...
            @forelse($clubsData as $clubName => $roles)
                <div class="space-y-4">
                    {{-- Club Header --}}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        {{-- Chairman --}}
                        @foreach($roles['chairman'] as $manager)
                            <div
                        ...
                        {{-- Secretary --}}
                        @foreach($roles['secretary'] as $manager)
                            <div
                                class="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 shadow-sm hover:shadow-md transition-shadow">
                                <div class="flex items-start space-x-3">
                                    <div class="flex-1 min-w-0">
                        ...
                        {{-- Accountant --}}
                        @foreach($roles['accountant'] as $manager)
                            <div
                                class="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 shadow-sm hover:shadow-md transition-shadow">
                                <div class="flex items-start space-x-3">
                                    <div class="flex-1 min-w-0">
                        ...
                        {{-- Breed Promoters --}}
                        @foreach($roles['promoters'] as $manager)
                            <div
                                class="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 shadow-sm hover:shadow-md transition-shadow">
                                <div class="flex items-start space-x-3">
                                    <div class="flex-1 min-w-0">
            ...
            @empty
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No Club Staff Found</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Club management information will appear here once available.
                    </p>
                </div>
            @endforelse
        </div>
